                                ...
                                <div className="container flex justify-center items-center flex-col w-full ">
                                    ...
                                    <div className="amount-checkout-container flex lg:flex-col md:flex-col flex-row justify-center w-full lg:items-end md:items-end items-center lg:mr-[10vw] md:mr-[10vw] lg:m-[25px] md:m-[25px]   ">
                                        ...
                                        <div className="checkout lg:text-[20px] md:text-[20px] flex justify-center items-center lg:mr-[25px] cursor-pointer hover:scale-110 rounded-lg border-2 border-black">
                                            <button className="checkout rounded-lg lg:p-[5px] md:px-[15px] p-[5px] lg:w-full md:w-full w-full lg:h-[7vh] flex flex-row items-center hover:scale-110 justify-center lg:text-[2vw] md:text-[3vw] text-[5vw]" disabled={!cart} onClick={() => {
                                                if (cart) {
                                                    Checkout();
